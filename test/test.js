...
module.exports = (Saver) => {
  ...
  const singleton = async () => {
    const saver = new Saver("singleton");
    const saver2 = new Saver("singleton");
    const saver3 = new Saver("singleton");
